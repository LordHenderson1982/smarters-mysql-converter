...
if(isset($_POST['submitU'])){
	...
	$stmt->bind_param(1, $_POST['title']);
	$stmt->bind_param(2, $_POST['message']);
	$stmt->bind_param(3, $_POST['created_on']);
	$stmt->bind_param(4, sanitize($_GET['update']));
	$stmt->execute();
...
if(isset($_GET['delete'])){
	...
	$stmt->bind_param(1, sanitize($_GET['delete']));
	$stmt->execute();
