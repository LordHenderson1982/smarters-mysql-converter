...
function seenstatus($data) {
    ...
    $stmt->bind_param("is", $announcement_id, $deviceid);
    $stmt->execute();
...
function getLastUpdated() {
    ...
    $response = [
        "result" => "success",
        "sc" => $sc,
        "lastupdate"=> "2024-06-01 17:12:34"
    ];
...
function processAdData() {
    ...
    $dashboardAds = [
        [
            ...
            "custom_recc" => "",
            "images" => $images,
            "text" => $ads2TextRow ? $ads2TextRow['text'] : ''
        ]
    ];
...
function fetchTMDBData() {
    ...
    $language = "en-US";
    $movies_url = "https://api.themoviedb.org/3/trending/movie/week?api_key=***&language=$language";
    $shows_url = "https://api.themoviedb.org/3/trending/tv/week?api_key=***&language=$language";
